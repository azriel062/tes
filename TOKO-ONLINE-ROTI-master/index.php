...
<div class="container-fluid" style="margin: 0;padding: 0;">
	<div class="image" style="margin-top: -21px">
		<img src="image/home/2(1).png" style="width: 100%;  height: 650px;">
	</div>
</div>
<br>
<br>
...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid hsl(154, 100%, 32%); border-bottom: 2px solid hsl(154, 100%, 32%);">Toko Roti Balikpapan adalah brand baru yang dibuat untuk menyediakan stock roti berkualitas untuk memenuhi kebutuhan pasar masyarakat balikpapan</h4>


	<h2 style=" width: 100%; border-bottom: 4px solid hsl(154, 100%, 32%); margin-top: 80px;"><b>Produk Kami</b></h2>
